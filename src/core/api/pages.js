  ...
  await client.cache.writeQuery({
    ...
    data: {
      pairs: pairs.map((pair) => {
        ...
        const volumeUSDGainedYesterday =
          oneDayPair?.volumeUSD - twoDayPair?.volumeUSD;
        ...
        const reserveUSDGainedYesterday =
          oneDayPair?.reserveUSD - twoDayPair?.reserveUSD;
        return {
          ...pair,
          feesUSDGained,
